...
<div class="container-fluid">
    <br>
    <h2 class="mb-4">Search for claims and Generate Reports<span><a href="/admin" class="btn btn-primary float-right">Reporting Dashboard</a></span></h2>
