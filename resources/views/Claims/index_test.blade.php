...
{{--                            <th style="width:100px; min-width:100px;" class="text-center text-danger"><i class="fa fa-bolt"> </i></th>--}}
                        ...
                        @foreach ($myClaims as $myClaim)
                            ...
                            <?php 
                            $myClaim1 = var_dump($myClaim->attachment);
                            $myClaim1 = (string)$myClaim->attachment;
                            $myClaim1 =  $myClaim->attachment;
                            $myClaim1 = str_replace($myClaim,"[","");
                            
                            ?>
                                                       
                                <!--<td> <a href="https://providers.aar-insurance.com/pdf/{{ $myClaim->attachment }}">my document</a></td> -->
                                <td> <a href="https://providers.aar-insurance.com/pdf/{{ $myClaim1}}">my document</a></td>
